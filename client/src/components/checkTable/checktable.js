...
const CommonCheckTable = (props) => {
    ...
    const data = useMemo(() => {
        ...
        return processData();
    }, [AdvanceSearch, displaySearchData, searchedDataOut, searchedData, allData, error]);
    ...
    if (error) {
        return <Text color="red.500">Error loading table data: {error.message}</Text>;
    }
